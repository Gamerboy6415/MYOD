...
class Generate_Text:
    ...
    def create_zczc(self):
        ...
        if len(CALLSIGN) > 8: CALLSIGN = "DASDEC "; print("[GENERATE]: Your callsign is too long!")
        elif len(CALLSIGN) < 8: CALLSIGN = "DASDEC "; print("[GENERATE]: Your callsign is too short!")
        elif "-" in CALLSIGN: CALLSIGN = "DASDEC "; print("[GENERATE]: Your callsign contains an invalid symbol!")
